...
public class SecondaryOrganismsController {
    ...
    @ApiOperation(value = "Get Secondary Organism By Accession", response = Iterable.class)
    ...
    @ApiOperation(value = "Get Filters for Secondary Organisms", response = Iterable.class)
    ...
    @ApiOperation(value = "Get Specimen By Accession", response = Iterable.class)
